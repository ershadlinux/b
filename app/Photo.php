...
//-------------------------------------------------------------------------------------------------------------
    ...
    public static function formFrom(UploadedFile $file2)
    {
        $photo = new static();
        $photo->file = $file2;
...
//             thumbnail_path=>static::thumbnailPath()
//
//        ]);
    }

    public function filName()
    {
...
//   exam     self::formFrom();
    ...
    {
        return $this->baseDir().'/'.$this->filName();
    }

    public function thumbnailPath()
    {
        return $this->baseDir().'/tn-'.$this->filName();
    }
    ...
    public function upload()
    {
        ...
        $this->file->move($this->baseDir(), $this->filName());
        $this->makeThumbnail();
        return $this;
